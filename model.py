...
class Kalle(nn.Module):
    def __init__(
        ...
        self.audio_linear = nn.Linear(256,2048,dtype=torch.bfloat16) if self.use_fa else nn.Linear(256,2048)
        self.distribution_linear = nn.Linear(2048,512,dtype=torch.bfloat16) if self.use_fa else nn.Linear(2048,512)
